...
class CourseOrderApiIntegrationTest {
    ...
    private static final UUID IDEMPOTENCY_KEY =
            UUID.fromString("b6ccac9b-fe4e-48f3-8cd2-81dbbeb4ad01");
    ...
    @MockitoBean private CourseOrderUseCase orders;
    ...
    void createsFromJwtIdentityAndReturnsCreatedOnlyForTheFirstRequest() throws Exception {
        ...
        verify(orders, org.mockito.Mockito.times(2))
                .create(
                        new CreateCourseOrderCommand(
                                USER_ID, "clean-architecture", IDEMPOTENCY_KEY));
    }
