...
@Component
public class LessonCompletedAnalyticsRecordMapper {
    ...
    private final AnalyticsKafkaConsumerProperties properties;

    public LessonCompletedAnalyticsRecordMapper(
    ...
    public ProjectLessonCompletionCommand toCommand(ConsumerRecord<String, String> record) {
